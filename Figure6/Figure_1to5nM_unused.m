...
% and then switched to a 1- 5 nM pheromone gradient
load('FigureData/Figure7A2.mat')
seeds = 10;
...
text(34,75,'Gradient (1-5 nM)','fontsize',25,'color','#0072BD')
...
load('Coordinates/Figure7A2_coordinates.mat')
r = 2.5;
subplot(10,10,[1,2,11,12,21,22])
plot_sphere(x_1,y_1,z_1,r,90,0);
text(0,-0.5,-3.5,'1 min','fontsize',25)

subplot(10,10,[3,4,13,14,23,24])
...
text(0,-0.5,-3.5,'60 min','fontsize',25)

subplot(10,10,[7,8,17,18,27,28])
plot_sphere(x_4,y_4,z_4,r,90,0);
text(0,-0.5,-3.5,'70 min','fontsize',25)

subplot(10,10,[9,10,19,20,29,30])
Gaussian_on_a_sphere(1,4)
title('1-5 nM gradient','position',[0,0,1.3])

...
% Simulations were performed with 1.5 nM uniform pheromone for the first 5 min 
% and then switched to a 1.5-5.8 nM pheromone gradient
...
load('Coordinates/Figure6A_coordinates.mat')
r = 2.5;
...
title('1.5-5.8 nM gradient','position',[0,0,1.3])

...
directory = '3D_Combined_polarity_circuit_with_pheromone';
mkdir(directory);
    ...
    for u = 1:numel(n_Cdc42)
        for v = 1:numel(n_BemGEF)
            for w = 1:numel(n_FarGEF)
                ...
                fprintf(fid,'sbatch -p general -N 1 -J Smoldyn -t 264:00:00 --mem=15g --wrap="/nas/longleaf/home/kaiyun/Smoldyn/cmake/smoldyn %s"\n',cfg_name);
            end
        end
    end
end

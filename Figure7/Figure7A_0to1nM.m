...
text(34,75,'Gradient (0-1 nM)','fontsize',25,'color','#0072BD')
...
load('Coordinates/Figure7A3_coordinates.mat')
r = 2.5;
...
title('0-1 nM gradient','position',[0,0,1.3])
